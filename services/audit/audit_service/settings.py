...
if not SECRET_KEY:
    if DEBUG:
        SECRET_KEY = 'django-insecure-audit-dev-key'
    else:
...
if os.environ.get('AUDIT_POSTGRES_HOST'):
    DATABASES = {'default': {
        ...
        'NAME': os.environ.get('AUDIT_POSTGRES_DB') or 'audit',
        'USER': os.environ.get('AUDIT_POSTGRES_USER') or 'audit',
        'PASSWORD': os.environ.get('AUDIT_POSTGRES_PASSWORD') or 'audit',
        'HOST': os.environ.get('AUDIT_POSTGRES_HOST') or 'localhost',
        'PORT': os.environ.get('AUDIT_POSTGRES_PORT') or '5432',
    }}
else:
    DATABASES = {'default': {
